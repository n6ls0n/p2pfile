...
export const PeerConnection = {
    ...
    connectPeer: (id: string) => new Promise<void>((resolve, reject) => {
        if (!peer) {
            reject(new Error ("Peer Hasn't Started"))
            return
        }
        ...
        try {
            ...
            if(!conn){
                ...
                // When the connection fails due to expiry, the error gets emitted to the peer instead of the connection. We need to be able to handle this here and to able to fulfill the Promise.
